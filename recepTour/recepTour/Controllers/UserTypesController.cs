...
namespace recepTour.Controllers
{
    public class UserTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,UserType1")] UserType userType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,UserType1")] UserType userType)
        {
            if (id != userType.Id)
            {
                return NotFound();
